...
async function testFeedbackSystem() {
    try {
        ...
        const feedback1 = await feedback_service_1.default.submitModuleFeedback(testUser.id, testModule1.id, 5, // 5-star rating
        ...
        const feedback2 = await feedback_service_1.default.submitModuleFeedback(testUser.id, testModule2.id, 3, // 3-star rating
        ...
        const feedback3 = await feedback_service_1.default.submitModuleFeedback(testUser2.id, testModule1.id, 4, // 4-star rating
        ...
        const feedback4 = await feedback_service_1.default.submitModuleFeedback(testUser2.id, testModule2.id, 2, // 2-star rating
        ...
        const moduleFeedback = await feedback_service_1.default.getModuleFeedback(testModule1.id);
        ...
        console.log('\n--- TEST 4: Update Existing Feedback ---');
        const updatedFeedback = await feedback_service_1.default.submitModuleFeedback(testUser.id, testModule1.id, 4, // Change from 5 to 4 stars
        ...
        const moduleAnalytics = await feedback_service_1.default.getModuleFeedbackAnalytics(testModule1.id);
        ...
        console.log('\n--- TEST 6: Overall Feedback Analytics ---');
        const overallAnalytics = await feedback_service_1.default.getOverallFeedbackAnalytics();
        ...
        const specificFeedback = await feedback_service_1.default.getFeedbackById(feedback1.id);
        ...
        const deletedFeedback = await feedback_service_1.default.deleteFeedback(feedback4.id, testUser2.id, false);
        if (deletedFeedback) {
